...
function sharePdf(id) {
  ...
  const printable = `<!doctype html><html><head><meta charset="utf-8"><title>${escapeHtml(fileName)}</title><link rel="stylesheet" href="styles.css"><style>@page{size:A4 portrait;margin:7mm} body{font-size:10px;background:#fff} .main-content,.content{padding:0!important} .card{box-shadow:none!important;border:0!important;margin:0!important;padding:0!important} .plan-table-wrap{overflow:visible!important} .plan-table,.plan-table-compact{table-layout:fixed!important;width:100%!important;min-width:0!important} .plan-table th,.plan-table td,.plan-table-compact th,.plan-table-compact td{padding:3px 4px!important;font-size:9px!important} .plan-table th:first-child,.plan-table td:first-child,.plan-table-compact .day-col{width:66px!important;min-width:66px!important;max-width:66px!important} .plan-cell{padding:2px 2px!important;font-size:8.2px!important;line-height:1.1!important;border-radius:4px!important;min-width:0!important} .summary-table th,.summary-table td,.summary-table-compact th,.summary-table-compact td{padding:4px 5px!important;font-size:9px!important} .legend{font-size:9px!important;gap:4px!important;margin-top:6px!important} .no-print{display:none!important}</style></head><body><main class="main-content">${renderPlanPreview(plan)}</main><script>window.onload=()=>window.print()</script></body></html>`;
